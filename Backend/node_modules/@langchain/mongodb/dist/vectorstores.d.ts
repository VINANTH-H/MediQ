 ...
 */
interface MongoDBRerankOptions {
  /**
...
declare class MongoDBAtlasVectorSearch extends VectorStore {
  ...
  private readonly rerankOptions?;
  ...
  private textBasedRerankSearchWithScore;
  private rerankSearchWithScore;
  /**
  ...
  static fromDocuments(docs: Document[], dbConfig: MongoDBAtlasVectorSearchLibArgs & {
    ids?: string[];
  }): Promise<MongoDBAtlasVectorSearch>;
  /**
...
//#endregion
export { MongoDBAtlasVectorSearch, MongoDBAtlasVectorSearchLibArgs, MongoDBRerankOptions };
